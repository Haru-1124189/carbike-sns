  ...
  const faqs = [
    ...
    { 
      ...
      items: [
        ...
        { 
          q: '車種申請で必要な情報は何ですか？', 
          a: 'メーカー名、モデル名、年式レンジ（開始年月〜終了年月）が必要です。複数の年式レンジを一度に申請できます。' 
        },
        { 
          q: '車種申請の審査期間はどのくらいですか？', 
          a: '通常1-3営業日程度で審査が完了します。承認されると自動でデータベースに追加され、愛車登録で選択できるようになります。' 
        },
        { 
          q: '車種申請が却下された場合は？', 
          a: '却下理由を確認し、正確な情報で再申請できます。重複申請や不正確な情報が主な却下理由です。' 
        },
        { 
          q: '車種データベースにはどのような車種が含まれていますか？', 
          a: '日本で販売された主要な車・バイクのメーカー・モデルが含まれています。輸入車や特殊車両は申請が必要な場合があります。' 
        },
      ]
    },
    ...
    { 
      ...
      items: [
        ...
        { 
          q: '車種申請が送信できません', 
          a: 'メーカー名、モデル名、年式レンジがすべて入力されているか確認してください。年式レンジは開始年月と終了年月の両方が必要です。' 
        },
        { 
          q: '車種申請の審査が長いです', 
          a: '通常1-3営業日程度で審査が完了します。土日祝日は審査対象外です。申請状況は通知で確認できます。' 
        },
        { 
